...
git merge -X subtree=drivers/staging/qcacld-3.0 FETCH_HEAD --log
...
git merge -X subtree=drivers/staging/fw-api FETCH_HEAD --log
...
git merge -X subtree=drivers/staging/qca-wifi-host-cmn FETCH_HEAD --log
